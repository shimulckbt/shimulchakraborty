                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="post" action="{{ route('homecontent.update') }}">
                                    ...
                                    <div class="form-group">
                                        <label class="info-title">About Description </label>
                                        {{-- <textarea class="form-control" name="tech_description" id="summernote">{{ $homecontent->tech_description }}</textarea> --}}
                                        <textarea class="form-control" name="tech_description">{{ $homecontent->tech_description }}</textarea>
                                    </div>


                                    <div class="form-group">
                                        <label class="info-title">Total Student </label>
                                        <input type="text" name="total_student"
                                            class="form-control input-default "value="{{ $homecontent->total_student }}">
                                        @error('total_student')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
